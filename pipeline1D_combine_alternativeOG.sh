...
do
   ...
   # echo Background Subtraction Targets
    ...
    echo "Plastic sidebands"
    mkdir -p ${datadDir}/combined/PlasticSidebandst02z26
    cd ${datadDir}/combined/PlasticSidebandst02z26
    cp ${datadDir}/${savedir}/PlasticSidebands/PlasticBkg_${playlist}_t2_z26_sys.root .

    mkdir -p ${datadDir}/combined/PlasticSidebandst02z82
    cd ${datadDir}/combined/PlasticSidebandst02z82
    cp ${datadDir}/${savedir}/PlasticSidebands/PlasticBkg_${playlist}_t2_z82_sys.root .

    mkdir -p ${datadDir}/combined/PlasticSidebandst03z06
    cd ${datadDir}/combined/PlasticSidebandst03z06
    cp ${datadDir}/${savedir}/PlasticSidebands/PlasticBkg_${playlist}_t3_z06_sys.root .

    mkdir -p ${datadDir}/combined/PlasticSidebandst03z26
    cd ${datadDir}/combined/PlasticSidebandst03z26
    cp ${datadDir}/${savedir}/PlasticSidebands/PlasticBkg_${playlist}_t3_z26_sys.root .

    mkdir -p ${datadDir}/combined/PlasticSidebandst03z82
    cd ${datadDir}/combined/PlasticSidebandst03z82
    cp ${datadDir}/${savedir}/PlasticSidebands/PlasticBkg_${playlist}_t3_z82_sys.root .

    mkdir -p ${datadDir}/combined/PlasticSidebandst04z82
    cd ${datadDir}/combined/PlasticSidebandst04z82
    cp ${datadDir}/${savedir}/PlasticSidebands/PlasticBkg_${playlist}_t4_z82_sys.root .

    mkdir -p ${datadDir}/combined/PlasticSidebandst05z26
    cd ${datadDir}/combined/PlasticSidebandst05z26
    cp ${datadDir}/${savedir}/PlasticSidebands/PlasticBkg_${playlist}_t5_z26_sys.root .

    mkdir -p ${datadDir}/combined/PlasticSidebandst05z82
    cd ${datadDir}/combined/PlasticSidebandst05z82
    cp ${datadDir}/${savedir}/PlasticSidebands/PlasticBkg_${playlist}_t5_z82_sys.root .
...
python ${scriptDir}/combinePlaylistHistos_forDaisyNOW.py ${datadDir}/combined/Efficiencyt02z26 ${datadDir}/combined/EventSelectiont02z26/ ../Efficiency_${combinedVersion}_t2_z26_sys.root
python ${scriptDir}/combinePlaylistHistos_forDaisyNOW.py ${datadDir}/combined/Efficiencyt02z82 ${datadDir}/combined/EventSelectiont02z82/ ../Efficiency_${combinedVersion}_t2_z82_sys.root
python ${scriptDir}/combinePlaylistHistos_forDaisyNOW.py ${datadDir}/combined/Efficiencyt03z26 ${datadDir}/combined/EventSelectiont03z26/ ../Efficiency_${combinedVersion}_t3_z26_sys.root
python ${scriptDir}/combinePlaylistHistos_forDaisyNOW.py ${datadDir}/combined/Efficiencyt03z06 ${datadDir}/combined/EventSelectiont03z06/ ../Efficiency_${combinedVersion}_t3_z06_sys.root
python ${scriptDir}/combinePlaylistHistos_forDaisyNOW.py ${datadDir}/combined/Efficiencyt03z82 ${datadDir}/combined/EventSelectiont03z82/ ../Efficiency_${combinedVersion}_t3_z82_sys.root
python ${scriptDir}/combinePlaylistHistos_forDaisyNOW.py ${datadDir}/combined/Efficiencyt04z82 ${datadDir}/combined/EventSelectiont04z82/ ../Efficiency_${combinedVersion}_t4_z82_sys.root
python ${scriptDir}/combinePlaylistHistos_forDaisyNOW.py ${datadDir}/combined/Efficiencyt05z26 ${datadDir}/combined/EventSelectiont05z26/ ../Efficiency_${combinedVersion}_t5_z26_sys.root
python ${scriptDir}/combinePlaylistHistos_forDaisyNOW.py ${datadDir}/combined/Efficiencyt05z82 ${datadDir}/combined/EventSelectiont05z82/ ../Efficiency_${combinedVersion}_t5_z82_sys.root
python ${scriptDir}/combinePlaylistHistos_forDaisyNOW.py ${datadDir}/combined/Efficiencyt99z99 ${datadDir}/combined/EventSelectiont99z99/ ../Efficiency_${combinedVersion}_t99_z99_sys.root
python ${scriptDir}/combinePlaylistHistos_forDaisyNOW.py ${datadDir}/combined/Efficiencyt99z99Daisy ${datadDir}/combined/EventSelectiont99z99Daisy/ ../Efficiency_Daisy_${combinedVersion}_t99_z99_sys.root
