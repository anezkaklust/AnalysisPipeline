...
do
    ...
    cp ${datadDir}/${savedir}/BackgroundSubtracted/BkgSubtracted_EventSelection2D_${playlist}_t99_z99_sys.root .

    mkdir -p ${datadDir}/combined/BackgroundSubtractedt99z99Daisy
    cd ${datadDir}/combined/BackgroundSubtractedt99z99Daisy
    cp ${datadDir}/${savedir}/BackgroundSubtracted/BkgSubtracted_EventSelection2D_daisy_${playlist}_t99_z99_sys.root .
    : '
    echo "Migration"
...
: '
python ${scriptDir}combinePlaylistHistos.py ${datadDir}/combined/BackgroundSubtractedt99z99/ ../BkgSubtracted_EventSelection2D_${combinedVersion}_t99_z99_sys.root
python ${scriptDir}combinePlaylistHistos.py ${datadDir}/combined/BackgroundSubtractedt99z99Daisy/ ../BkgSubtracted_EventSelection2D_daisy_${combinedVersion}_t99_z99_sys.root
: '
...
mkdir -p "BackgroundSubtracted"
cd "BackgroundSubtracted"
mv ${datadDir}/combined/BkgSubtracted_EventSelection2D_${combinedVersion}*.root .
mv ${datadDir}/combined/BkgSubtracted_EventSelection2D_daisy_${combinedVersion}*.root .
...
./plotBkgSubtracted2D ${datadDir}/combined/BackgroundSubtracted ${datadDir}/combined/BackgroundSubtracted 99 99 ${combinedVersion} 
...
./plotDaisyBkgSubtracted2D ${datadDir}/combined/BackgroundSubtracted ${datadDir}/combined/BackgroundSubtracted ${combinedVersion} 
