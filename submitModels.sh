...
# /pnfs/minerva/persistent/Models/NEUT/Medium_Energy/RHC/v5.0.2/nuclear/LFG_ma105
# /pnfs/minerva/persistent/Models/NEUT/Medium_Energy/RHC/v5.0.2/nuclear/SF_ma103
...
echo ============== Carbon ==============
echo ====================================
python SubmitJobsToGrid_MAT_Tutorial.py --outdir /pnfs/minerva/persistent/users/${USER}/${indir}/ --stage eventLoop --basedir ${basedir} --runcommand "python modelComparison/plotXSecFromNUISANCE.py LFGma105_carbon root://fndca1.fnal.gov:1094/pnfs/fnal.gov/usr/minerva/persistent/Models/NEUT/Medium_Energy/RHC/v5.0.2/nuclear/LFG_ma105/carbon/flat_NEUT_tune_LFG_maqe1.05_50M.root"

echo ============== Iron ================
echo ====================================
python SubmitJobsToGrid_MAT_Tutorial.py --outdir /pnfs/minerva/persistent/users/${USER}/${indir}/ --stage eventLoop --basedir ${basedir} --runcommand "python modelComparison/plotXSecFromNUISANCE.py LFGma105_iron root://fndca1.fnal.gov:1094/pnfs/fnal.gov/usr/minerva/persistent/Models/NEUT/Medium_Energy/RHC/v5.0.2/nuclear/LFG_ma105/iron/flat_NEUT_tune_LFG_maqe1.05_50M.root"

echo ============== Lead ================
echo ====================================
python SubmitJobsToGrid_MAT_Tutorial.py --outdir /pnfs/minerva/persistent/users/${USER}/${indir}/ --stage eventLoop --basedir ${basedir} --runcommand "python modelComparison/plotXSecFromNUISANCE.py LFGma105_lead root://fndca1.fnal.gov:1094/pnfs/fnal.gov/usr/minerva/persistent/Models/NEUT/Medium_Energy/RHC/v5.0.2/nuclear/LFG_ma105/lead/flat_NEUT_tune_LFG_maqe1.05_50M.root"

echo ============== Tracker =============
echo ====================================
python SubmitJobsToGrid_MAT_Tutorial.py --outdir /pnfs/minerva/persistent/users/${USER}/${indir}/ --stage eventLoop --basedir ${basedir} --runcommand "python modelComparison/plotXSecFromNUISANCE.py LFGma105_tracker root://fndca1.fnal.gov:1094/pnfs/fnal.gov/usr/minerva/persistent/Models/NEUT/Medium_Energy/RHC/v5.0.2/tracker/LFG_ma105/tracker/flat_NEUT_tune_LFG_maqe1.05_50M.root"
...
echo ============== Carbon ==============
echo ====================================
python SubmitJobsToGrid_MAT_Tutorial.py --outdir /pnfs/minerva/persistent/users/${USER}/${indir}/ --stage eventLoop --basedir ${basedir} --runcommand "python modelComparison/plotXSecFromNUISANCE.py SFma103_carbon root://fndca1.fnal.gov:1094/pnfs/fnal.gov/usr/minerva/persistent/Models/NEUT/Medium_Energy/RHC/v5.0.2/nuclear/SF_ma103/carbon/flat_NEUT_tune_SF_maqe1.03_set_50M.root"

echo ============== Iron ================
echo ====================================
python SubmitJobsToGrid_MAT_Tutorial.py --outdir /pnfs/minerva/persistent/users/${USER}/${indir}/ --stage eventLoop --basedir ${basedir} --runcommand "python modelComparison/plotXSecFromNUISANCE.py SFma103_iron root://fndca1.fnal.gov:1094/pnfs/fnal.gov/usr/minerva/persistent/Models/NEUT/Medium_Energy/RHC/v5.0.2/nuclear/SF_ma103/iron/flat_NEUT_tune_SF_maqe1.03_set_50M.root"

echo ============== Lead ================
echo ====================================
python SubmitJobsToGrid_MAT_Tutorial.py --outdir /pnfs/minerva/persistent/users/${USER}/${indir}/ --stage eventLoop --basedir ${basedir} --runcommand "python modelComparison/plotXSecFromNUISANCE.py SFma103_lead root://fndca1.fnal.gov:1094/pnfs/fnal.gov/usr/minerva/persistent/Models/NEUT/Medium_Energy/RHC/v5.0.2/nuclear/SF_ma103/lead/flat_NEUT_tune_SF_maqe1.03_set_50M.root"

echo ============== Tracker =============
echo ====================================
python SubmitJobsToGrid_MAT_Tutorial.py --outdir /pnfs/minerva/persistent/users/${USER}/${indir}/ --stage eventLoop --basedir ${basedir} --runcommand "python modelComparison/plotXSecFromNUISANCE.py SFma103_tracker root://fndca1.fnal.gov:1094/pnfs/fnal.gov/usr/minerva/persistent/Models/NEUT/Medium_Energy/RHC/v5.0.2/tracker/SF_ma103/tracker/flat_NEUT_tune_SF_maqe105_50M.root"
